    ...
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        <form class="login100-form validate-form">
          ...
          <span class="login100-form-title p-b-26 text-dark"
            >ورود به ناحیه کاربری</span
          >

          <!-- please enter your email -->
          <div
            class="wrap-input100 validate-input"
            data-validate="فرمت ایمیل وارد شده صحیح نمی باشد!"
          >
            <input class="input100" type="text" name="email" />
            <span
              class="focus-input100"
              data-placeholder="پست الکترونیک"
            ></span>
          </div>
          <!--  / please enter your email -->
          ...
          <div
            class="wrap-input100 validate-input"
            data-validate="لطفا رمز عبور خود را وارد کنید!"
          >
          ...
          <div class="text-center p-t-115">
            ...
            <a class="txt2 text-danger">ثبت نام کنید</a>
          </div>
          <!-- / register-->
        </form>
        <!-- / form -->
